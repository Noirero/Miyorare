...
class ExclusiveThemeMixerTest {
	...
	fun `custom loadout mixes foundation wallpaper navigation accent and glow centrally`() {
		...
		val wallpaper = resolve(wallpaperId)
		...
		assertEquals(wallpaper.tokens.background, resolved.tokens.background)
		assertEquals(wallpaper.tokens.backgroundGradientStart, resolved.tokens.backgroundGradientStart)
