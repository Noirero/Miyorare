...
/**
 * Passive adaptive policy for periodic library updates.
 *
 * Manual/full checks bypass this policy. Periodic checks prioritise titles that are actually due,
 * while old/inactive titles and repeatedly unhealthy sources receive a bounded cooldown.
 */
@Reusable
