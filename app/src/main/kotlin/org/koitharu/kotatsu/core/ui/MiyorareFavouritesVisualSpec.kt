...
object MiyorareFavouritesVisualSpec {
	...
	const val BOTTOM_NAV_CONTAINER_ALPHA = 146
	const val BOTTOM_NAV_SELECTED_ALPHA = 184
	...
	const val BOTTOM_NAV_GRADIENT_START_ALPHA = 148
	const val BOTTOM_NAV_GRADIENT_CENTER_ALPHA = 128
	const val BOTTOM_NAV_GRADIENT_END_ALPHA = 142
	const val BOTTOM_NAV_INACTIVE_CONTENT_ALPHA = 0.84f
	const val BOTTOM_NAV_OUTER_GLOW_ALPHA = 0.13f
	const val BOTTOM_NAV_MID_GLOW_ALPHA = 0.24f
	const val BOTTOM_NAV_BORDER_ALPHA = 0.98f
	const val BOTTOM_NAV_SELECTED_BORDER_ALPHA = 1f
	const val BOTTOM_NAV_SELECTED_HALO_ALPHA = 0.16f
	const val BOTTOM_NAV_SELECTED_MID_HALO_ALPHA = 0.30f
