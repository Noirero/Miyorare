...
object MiyorareFavouritesVisualSpec {
	...
	const val BOTTOM_NAV_CONTAINER_ALPHA = 176
	const val BOTTOM_NAV_SELECTED_ALPHA = 212
	...
	const val BOTTOM_NAV_GRADIENT_START_ALPHA = 188
	const val BOTTOM_NAV_GRADIENT_CENTER_ALPHA = 168
	const val BOTTOM_NAV_GRADIENT_END_ALPHA = 180
	const val BOTTOM_NAV_INACTIVE_CONTENT_ALPHA = 0.84f
	const val BOTTOM_NAV_OUTER_GLOW_ALPHA = 0.16f
	const val BOTTOM_NAV_BORDER_ALPHA = 0.88f
