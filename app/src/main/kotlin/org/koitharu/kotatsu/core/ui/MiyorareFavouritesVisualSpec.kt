...
object MiyorareFavouritesVisualSpec {
	...
	// Top chrome / header.
	const val SEARCH_VISUAL_HEIGHT_DP = 44f
	const val SEARCH_SIDE_BUTTON_DP = 44f
	...
	const val CONTENT_TOGGLE_HEIGHT_DP = 46f
	const val CONTENT_TOGGLE_HORIZONTAL_MARGIN_DP = 20f
	const val CONTENT_TOGGLE_INSET_DP = 3f
	const val CONTENT_TOGGLE_TOP_GAP_DP = 9f
	const val CONTENT_TOGGLE_BOTTOM_GAP_DP = 5f
	const val CONTENT_TOGGLE_BUTTON_MIN_HEIGHT_DP = 40f
	const val CONTENT_TOGGLE_ICON_DP = 20f
	const val CONTENT_TOGGLE_ICON_GAP_DP = 6f
	const val CONTENT_TOGGLE_TEXT_SP = 14f

	// Category rail.
	const val CATEGORY_RAIL_HEIGHT_DP = 38f
	const val CATEGORY_RAIL_HORIZONTAL_MARGIN_DP = 14f
	const val CATEGORY_RAIL_TOP_GAP_DP = 5f
	const val CATEGORY_RAIL_BOTTOM_GAP_DP = 5f
	const val CATEGORY_RAIL_INSET_DP = 6f
	const val CATEGORY_TAB_MIN_HEIGHT_DP = 32f
	const val CATEGORY_TAB_HORIZONTAL_PADDING_DP = 7f
	const val CATEGORY_SELECTED_SURFACE_ALPHA_FACTOR = 0.34f

	// Quick actions.
	const val QUICK_FILTER_HEIGHT_DP = 34f
	const val QUICK_FILTER_RADIUS_DP = 17f
	...
	const val QUICK_FILTER_TOP_PADDING_DP = 3f
	const val QUICK_FILTER_BOTTOM_PADDING_DP = 3f
	...
	const val MANGA_CARD_BORDER_WIDTH_DP = 1.1f

	// Bottom navigation.
	const val BOTTOM_NAV_HORIZONTAL_MARGIN_DP = 18f
	const val BOTTOM_NAV_VERTICAL_MARGIN_DP = 8f
	const val BOTTOM_NAV_HEIGHT_DP = 70f
	const val BOTTOM_NAV_RADIUS_DP = 30f
	const val BOTTOM_NAV_ITEM_RADIUS_DP = 24f
	const val BOTTOM_NAV_SELECTED_HEIGHT_DP = 60f
	const val BOTTOM_NAV_DARK_THEME_SURFACE_MIX = 0.58f
	const val BOTTOM_NAV_BASE_ACCENT_MIX = 0.16f
	const val BOTTOM_NAV_SELECTED_ACCENT_MIX = 0.62f
	const val BOTTOM_NAV_CONTAINER_ALPHA = 136
	const val BOTTOM_NAV_SELECTED_ALPHA = 174
	const val BOTTOM_NAV_GRADIENT_START_ACCENT_MIX = 0.18f
	const val BOTTOM_NAV_GRADIENT_CENTER_ACCENT_MIX = 0.12f
	const val BOTTOM_NAV_GRADIENT_END_ACCENT_MIX = 0.16f
	const val BOTTOM_NAV_GRADIENT_START_ALPHA = 138
	const val BOTTOM_NAV_GRADIENT_CENTER_ALPHA = 116
	const val BOTTOM_NAV_GRADIENT_END_ALPHA = 132
	const val BOTTOM_NAV_INACTIVE_CONTENT_ALPHA = 0.84f
	const val BOTTOM_NAV_OUTER_GLOW_ALPHA = 0.18f
	const val BOTTOM_NAV_MID_GLOW_ALPHA = 0.34f
	const val BOTTOM_NAV_BORDER_ALPHA = 0.98f
	const val BOTTOM_NAV_SELECTED_BORDER_ALPHA = 1f
	const val BOTTOM_NAV_SELECTED_HALO_ALPHA = 0.24f
	const val BOTTOM_NAV_SELECTED_MID_HALO_ALPHA = 0.46f
