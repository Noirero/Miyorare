...
object MiyorareFavouritesVisualSpec {
	...
	const val BOTTOM_NAV_CONTAINER_ALPHA = 148
	const val BOTTOM_NAV_SELECTED_ALPHA = 188
	const val BOTTOM_NAV_GRADIENT_START_ACCENT_MIX = 0.30f
	const val BOTTOM_NAV_GRADIENT_CENTER_ACCENT_MIX = 0.24f
	const val BOTTOM_NAV_GRADIENT_END_ACCENT_MIX = 0.28f
	const val BOTTOM_NAV_GRADIENT_START_ALPHA = 150
	const val BOTTOM_NAV_GRADIENT_CENTER_ALPHA = 134
	const val BOTTOM_NAV_GRADIENT_END_ALPHA = 144
	const val BOTTOM_NAV_INACTIVE_CONTENT_ALPHA = 0.84f
	const val BOTTOM_NAV_OUTER_GLOW_ALPHA = 0.20f
	const val BOTTOM_NAV_MID_GLOW_ALPHA = 0.28f
	const val BOTTOM_NAV_NEAR_GLOW_ALPHA = 0.44f
	const val BOTTOM_NAV_BORDER_ALPHA = 0.96f
	const val BOTTOM_NAV_SELECTED_BORDER_ALPHA = 1f
	const val BOTTOM_NAV_SELECTED_HALO_ALPHA = 0.28f
	const val BOTTOM_NAV_SELECTED_MID_HALO_ALPHA = 0.38f
	const val BOTTOM_NAV_SELECTED_NEAR_HALO_ALPHA = 0.58f
	const val BOTTOM_NAV_SELECTED_CENTER_ILLUMINATION_ALPHA = 0.70f
